...
<header class="w3-display-container w3-content w3-center" style="max-width:1500px">
  ...
  <div class="w3-display-middle w3-padding-large w3-border w3-wide w3-text-light-grey w3-center">
    ...
    <h3 class="w3-hide-medium w3-hide-small">W E B &nbsp; D E V E L O P E R</h3>
  </div>
...
<div class="w3-content w3-padding-large w3-margin-top" id="portfolio">
  ...
  <!-- Images (Portfolio) -->
  <img src="./Assets/work-day-scheduler.png" alt="Ocean" class="w3-image" width="1000" height="500">
  <img src="./Assets/team-profile.png" alt="Ocean II" class="w3-image w3-margin-top" width="1000" height="500">
  <img src="./Assets/cheqmate.png" alt="Falls" class="w3-image w3-margin-top" width="1000" height="500">
